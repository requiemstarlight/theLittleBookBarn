...
booksObj.forEach((book) => {
  ...
  if(book.reviewer === currentUser && book.approved == 0) {
    ...
    deleteBtns.forEach((btn) => {
      btn.addEventListener('click', (e) => {
        ...
        Confirm.open({ 
                    ...
                    okText: "Confirm",
                    cancelText: "Cancel",
                    onok: () => window.document.location = "includes/delete-inc.php" + "?bookId=" + selectedBook + "&location=editDeletePupil",
