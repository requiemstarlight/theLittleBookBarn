...
<!-- add an informative paragraph - different for teachers and pupils -->
        ...
        <?php 
            if($_SESSION['status'] === 'pupil') {
                ...
                echo "<div class='paragraph-container'>
                        <p>
                            Congratulations - your review has been edited. It has now been sent to your
                            teacher for approval. Once it has been approved, your edited review will be
                ...
                echo "<div class='paragraph-container'>
                <p>
                    Congratulations - your review has been edited. The new version is now
                    available on the website.
                </p>
            </div>";
            }
          ...
          <?php 
                    if($_SESSION['status'] === 'teacher') {
                      ...
                      echo "<p class='form-text'>
                            ...
                            Edit or Delete Pending Reviews
                            </a>
                            </p>";
                    }
                 ?>
